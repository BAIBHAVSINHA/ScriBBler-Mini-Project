...
if (localStorage.getItem(sessionStorage.getItem('postNo')) == 'false') {
    ...
    if(localStorage.getItem(likes) === '1')
        p.innerText = "1 person has liked the post";
    else
        p.innerText = localStorage.getItem(likes) + "people have liked the post";
}
span
    .classList
    .add('ml-1');
...
a.addEventListener('click', () => {
    if (localStorage.getItem(sessionStorage.getItem('postNo')) === 'false') {
        ...
        a
            .parentElement
            .querySelector('p')
            .innerText = localStorage.getItem(likes) + " people have liked this!"
    }
});
